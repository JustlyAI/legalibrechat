...
import { useUpdateUserPluginsMutation } from 'legallibrechat-data-provider/react-query';
import type { AssistantsEndpoint, TError, TPluginAction } from 'legallibrechat-data-provider';
